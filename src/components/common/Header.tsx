...
export const Header: React.FC<HeaderProps> = ({ currentView, onNavigate }) => {
  ...
  return (
    <header className="sticky top-0 z-40 w-full bg-white/90 dark:bg-slate-950/90 backdrop-blur border-b border-slate-200 dark:border-slate-800 transition-colors">
  ...
  <Clapperboard className="w-5 h-5 text-slate-900 dark:text-white" strokeWidth={2.5} />
</div>
            <div>
              <span className="font-extrabold text-lg text-slate-900 dark:text-slate-100 tracking-tight block leading-tight">
                ContentHub
              </span>
          ...
          <div className="flex md:hidden items-center gap-2">
            ...
            <button
              ...
              className="p-2 rounded-xl border border-slate-200 dark:border-slate-800 bg-slate-100 dark:bg-slate-900 text-slate-700 dark:text-slate-300 hover:text-slate-900 dark:hover:text-white"
