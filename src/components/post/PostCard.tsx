...
export const PostCard: React.FC<PostCardProps> = ({ post, onClick }) => {
  return (
    <article
      ...
      onClick={onClick}
      className="group relative bg-slate-900/90 hover:bg-slate-850 border border-slate-800 hover:border-indigo-500/50 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-indigo-500/10 transition-all duration-200 cursor-pointer flex flex-col justify-between"
    >
      ...
      <div>
        ...
        <div className="p-4 sm:p-5">
          ...
          <h3 className="font-bold text-sm sm:text-base text-slate-100 group-hover:text-indigo-400 transition-colors line-clamp-2 leading-snug mb-2">
            {post.title}
          </h3>
      ...
      <div className="px-4 sm:px-5 py-3 bg-slate-950/50 border-t border-slate-800/80 flex items-center justify-between text-xs text-slate-400">
        ...
        <span className="text-indigo-400 font-semibold text-xs flex items-center gap-1 group-hover:translate-x-0.5 transition-transform">
