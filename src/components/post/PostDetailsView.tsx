    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8 animate-fadeIn">
      ...
      <div className="flex items-center justify-between">
        <button
          ...
          type="button"
          onClick={onBack}
          className="py-2 px-3.5 rounded-xl border border-slate-800 bg-slate-900 hover:bg-slate-850 text-slate-300 hover:text-white text-xs font-semibold transition-all flex items-center gap-1.5 shadow-sm"
        >
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            type="button"
            onClick={handleShare}
            className="p-2 rounded-xl border border-slate-800 bg-slate-900 hover:bg-slate-800 text-slate-300 hover:text-white transition-all text-xs font-medium flex items-center gap-1.5"
      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-center gap-2">
          <button
            ...
            className="px-3 py-1 rounded-lg bg-indigo-500/10 text-indigo-300 border border-indigo-500/20 text-xs font-bold uppercase tracking-wider hover:bg-indigo-500/20 transition-all flex items-center gap-1.5"
          >
        ...
        <div className="flex items-center justify-between py-3 border-y border-slate-800/80 text-xs text-slate-400">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1.5">
              <Eye className="w-4 h-4 text-indigo-400" />
              <strong className="text-slate-200">{viewsCount.toLocaleString()}</strong> views
            </span>
            ...
            <span className="flex items-center gap-1.5">
              ...
              <strong className="text-slate-200">{likesCount.toLocaleString()}</strong> likes
            </span>
          </div>
          ...
          <button
            ...
            type="button"
            onClick={handleLike}
            className={`py-1.5 px-4 rounded-xl text-xs font-bold transition-all flex items-center gap-2 border shadow-sm ${
              isLiked
      ...
      <div className="p-6 sm:p-8 rounded-3xl bg-slate-900/60 border border-slate-800 space-y-4">
        <h3 className="text-base font-bold text-slate-200 uppercase tracking-wider text-xs text-indigo-400">
        ...
        {post.content && (
          <div className="pt-4 border-t border-slate-800 text-xs sm:text-sm text-slate-300 space-y-3 leading-relaxed whitespace-pre-line font-mono sm:font-sans">
            {post.content}
          </div>
        )}
